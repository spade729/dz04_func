...
Используя функции и в целом функциональный подход реалзовать ООП одход без использования синтаксиса классов, т.е. реализовать атрибуты и методы, Public/Protected/Private области, осуществить принципы ООП: наследование, инкапсуляция, полиморфизм и т.д. и т.п.. Может быть, хоть что-то из этого получится сделать.
